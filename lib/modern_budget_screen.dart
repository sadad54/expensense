...
//             : Column(
//           children: [
//             _buildOverallProgress(context, budgetProvider, currencyFormat)
//                 .animate()
//                 .fadeIn(duration: 500.ms)
//                 .slideY(begin: -0.2, end: 0, curve: Curves.easeOutCubic),
//             Expanded(
//                 child: _buildCategoryList(context, budgetProvider, currencyFormat)),
//           ],
//         ),
//       ),
...
//       NumberFormat currencyFormat,
//       ) {
//     if (provider.categories.isEmpty && !provider.isLoading) { // Check isLoading too
//       return Center(
//         child: Padding(
//           padding: const EdgeInsets.all(16.0),
//           child: Text(
...
//         return _buildCategoryCard(context, category, provider, currencyFormat, _showSpendInputDialog)
//             .animate()
...
//           crossAxisAlignment: CrossAxisAlignment.start,
//           children: [
//             Text("Allocated: ${NumberFormat.currency(symbol: '\$').format(allocated)}"),
//             Text("Current Spent: ${NumberFormat.currency(symbol: '\$').format(currentSpent)}"),
//             Text("Remaining: ${NumberFormat.currency(symbol: '\$').format(remainingBeforeNewSpend)}",
//               style: TextStyle(color: remainingBeforeNewSpend < 0 ? Colors.redAccent : Colors.greenAccent),
//             ),
//             SizedBox(height: 16),
//             TextField(
...
//                 _showCrimsonAlert(context, "❌ Please enter a valid positive number for spending.");
//                 return;
//               }
//               ;
...
//                 SnackBar(
//                   content: Text("✅ Added \$${amount.toStringAsFixed(2)} to ${category.name}",),
...
//           ],
//         ),
//         backgroundColor: Theme.of(context).colorScheme.errorContainer, // Use theme error color
//         behavior: SnackBarBehavior.floating,
...
//       Function(BuildContext, BudgetCategoryModel, ModernBudgetProvider) showSpendDialogFn,
//       ) {
//     double progress = category.allocatedAmount > 0
...
//       child: InkWell(
//         onTap: () => showSpendDialogFn(context, category, provider), // Use the passed function
//         onLongPress: () => _showCategoryForm(context, provider, existingCategory: category), // Keep long press for editing form
//         child: Padding(
//           padding: const EdgeInsets.all(16.0),
//           child: Column(
//             crossAxisAlignment: CrossAxisAlignment.start,
...
//                           content: Text('Are you sure you want to delete "${category.name}"?', style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.8))),
//                           actions: [
//                             TextButton(
...
//                           : Colors.greenAccent, // Lighter green for dark theme
//                     ),
//                   ),
//                 ],
//               ),
